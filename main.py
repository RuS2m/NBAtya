...
if __name__ == '__main__':
    ...
    try:
        ...
        dispatcher.add_handler(CommandHandler(command='gms', callback=games_in_season_link))
        ...
        dispatcher.add_handler(CallbackQueryHandler(game_in_season_button, pattern=r"gmsn_"))
